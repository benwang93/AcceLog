...
public class ArduinoCommunicatorService extends Service {
    ...
    final static String DATA_RECEIVED_INTENT = "benwang93.com.oscope.intent.action.DATA_RECEIVED";
    final static String SEND_DATA_INTENT = "benwang93.com.oscope.intent.action.SEND_DATA";
    final static String DATA_SENT_INTERNAL_INTENT = "benwang93.com.oscope.internal.intent.action.DATA_SENT";
    final static String DATA_EXTRA = "benwang93.com.oscope.intent.extra.DATA";
    final static String UPDATE_CHART_INTENT = "benwang93.com.oscope.intent.action.UPDATE_CHART";
    ...
    private void  parseForPacket(byte[] receiveBuff, int receiveBuffLen){
        ...
        do {
            try {
                ...
                Log.d("Oscope", "Parsed: SOP?" + SOPFound + " Len:" + remainingBuffLen + " str:\'" + new String(receiveBuff, currReceivePos, remainingBuffLen, "US-ASCII") + "\'");
